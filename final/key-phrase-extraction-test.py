...
# In this example, we're first calling the key-phrase-extraction-test function.
...
# To call the prod key-phrase-extraction function, uncomment the next line and comment out the key-phrase-extraction-test line
# function_name = 'key-phrase-extraction'
function_name = 'key-phrase-extraction-test'
