...
# In this example, we're first calling the image-contains-test function.
...
# To call the prod image-contains function, uncomment the next line and comment out the image-contains-test line
