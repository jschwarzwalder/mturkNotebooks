...
text1 = 'Fix test flakes'
text2 = 'Fix flaky tests'
...
put_result =  crowd_client.put_task('semantic-similarity', 'my-task-name', {'text1': "The sky is blue", 'text2': "The sky was the color of blue."})     
...
get_result = crowd_client.get_task('semantic-similarity', 'my-task-name')
